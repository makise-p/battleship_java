...
public class BsgamerandomVSSelfControl{
...
class Game{
	...
	public Game(){
		...
		players[1] = new SelfControlPlayer(this);//ここをSelfControlPlayerにすると自分で操作できる
	}
...
class SelfControlPlayer extends Player{
    ...
    public void think(){
        ...
        //Scanner AttackPoint = new Scanner(System.in);
        ...
        System.out.println("攻撃したいときは１、移動したいときは２を入力してください");
